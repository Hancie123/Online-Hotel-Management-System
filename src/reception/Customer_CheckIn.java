...
public class Customer_CheckIn implements MouseListener {
	...
	public Customer_CheckIn() {
		...
		north.setBackground(new Color(61, 108, 185));
		...
		center.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Customer Details", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255,255,255)));
		...
		checkinbtn.setBackground(new Color(255,255,255));
