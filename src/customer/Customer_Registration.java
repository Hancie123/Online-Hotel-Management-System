...
import regexExpression.RegexExpression;
import ui.Login;

public class Customer_Registration implements ActionListener  {
	...
	public Customer_Registration() {
		...
		Image img1 = new ImageIcon(this.getClass().getResource("Phishing account-bro.png")).getImage();
		...
		main1.setBackground(new Color(54, 79, 107));
		...
		customerClear.setBackground(new Color(0,0,0));
		...
		customersouth.setBackground(new Color(0,0,0));
