...
public class Customer_Management implements ActionListener,MouseListener {
	...
	public Customer_Management() {
		f = new JFrame("Customer Management System");
		f.setSize(1290, 700);
		f.setLocationRelativeTo(null);
		f.setLayout(new BorderLayout());
		f.setResizable(false);
		f.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("hotel.png")));

		//------------------------North Panel-----------------
		JPanel north = new JPanel();
		north.setBackground(new Color(34, 209, 238));
		north.setPreferredSize(new Dimension(100, 70));
		north.setLayout(null);
		f.add(north, BorderLayout.NORTH);

		//-----------------------Search Field in North Panel---------------------
		searchtxt = new JTextField();
		searchtxt.setBounds(30, 20, 250, 35);
		...
		searchtxt.addFocusListener(new FocusListener() {
		    ...
		    public void focusGained(FocusEvent e) {
		        if (searchtxt.getText().equals("Search Customer ID")) {
		        	searchtxt.setText("");
		    ...
		    public void focusLost(FocusEvent e) {
		        if (searchtxt.getText().isEmpty()) {
		        	...
		        	searchtxt.setText("Search Customer ID");
		        }
		    }
		    });
		...
		clearbtn.setBounds(420, 20, 100, 35);
		...
		search.setBounds(300, 20, 100, 35);
		...
		search.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == search) {
					...
					JDBCCustomer jdbc1 = new JDBCCustomer();
		...
		scroll.setBounds(400,20,500,450);
		...
		if (ae.getSource() == insertbtn) {
			...
			if (nametxt.getText().trim().isEmpty() || addresstxt.getText().trim().isEmpty()
				...
				if (result == true) {
					...
					JOptionPane.showMessageDialog(null, "You have registered customer successfully!",
			...
			JDBCCustomer jdbc3 = new JDBCCustomer();
